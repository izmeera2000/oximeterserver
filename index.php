    ...
    <header class="header header-sticky mb-4">
      <div class="container-fluid">
        ...
        <a class="header-brand d-md-none" href="#">
          <!-- logo -->
          <img style="height:48px" src="assets/favicon/android-icon-144x144.png" class="img" alt="Oximeter Logo">
          <!-- logo -->
        </a>
        <ul class="header-nav d-none d-md-flex">
          <li class="nav-item">
            <a class="nav-link" href="index.php">
              <!-- logo -->
              <img style="height:48px" src="assets/favicon/android-icon-144x144.png" class="img" alt="Logo">
              <!-- logo -->
              BME680 Server
            </a>
          </li>
